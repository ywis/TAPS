...
def minimize_age_AV_vector_weighted_M13(X):
    ...
    if age_prior < 1e-4:
        ...
        if galaxy_age >=1.25 and galaxy_age <1.5:
            ...
            fn1 = '/Volumes/My Passport/SSP_models/new/M13_age_1_5_Av_00_z002.csv'
            fn2 = '/Volumes/My Passport/SSP_models/new/M13_age_2_Av_00_z002.csv'
        ...
        if galaxy_age >= 1.0 and galaxy_age < 1.25:
            ...
            fn1 = '/Volumes/My Passport/SSP_models/new/M13_age_2_Av_00_z002.csv'
            fn2 = '/Volumes/My Passport/SSP_models/new/M13_age_3_Av_00_z002.csv'
            model2 = (3.0-galaxy_age)*np.genfromtxt(fn1) + (galaxy_age-2.0)*np.genfromtxt(fn2)
        elif galaxy_age >= 3.0 and galaxy_age < 4.0:
            fn1 = '/Volumes/My Passport/SSP_models/new/M13_age_3_Av_00_z002.csv'
            fn2 = '/Volumes/My Passport/SSP_models/new/M13_age_4_Av_00_z002.csv'
            model2 = (4.0-galaxy_age)*np.genfromtxt(fn1) + (galaxy_age-3.0)*np.genfromtxt(fn2)
        elif galaxy_age >= 4.0 and galaxy_age < 5.0:
            fn1 = '/Volumes/My Passport/SSP_models/new/M13_age_4_Av_00_z002.csv'
            fn2 = '/Volumes/My Passport/SSP_models/new/M13_age_5_Av_00_z002.csv'
            model2 = (5.0-galaxy_age)*np.genfromtxt(fn1) + (galaxy_age-4.0)*np.genfromtxt(fn2)
        elif galaxy_age >= 5.0 and galaxy_age < 6.0:
            fn1 = '/Volumes/My Passport/SSP_models/new/M13_age_5_Av_00_z002.csv'
            fn2 = '/Volumes/My Passport/SSP_models/new/M13_age_6_Av_00_z002.csv'
            model2 = (6.0-galaxy_age)*np.genfromtxt(fn1) + (galaxy_age-5.0)*np.genfromtxt(fn2)
        elif galaxy_age >= 6.0 and galaxy_age < 7.0:
            fn1 = '/Volumes/My Passport/SSP_models/new/M13_age_6_Av_00_z002.csv'
            fn2 = '/Volumes/My Passport/SSP_models/new/M13_age_7_Av_00_z002.csv'
            model2 = (7.0-galaxy_age)*np.genfromtxt(fn1) + (galaxy_age-6.0)*np.genfromtxt(fn2)
        elif galaxy_age >= 7.0 and galaxy_age < 8.0:
            fn1 = '/Volumes/My Passport/SSP_models/new/M13_age_7_Av_00_z002.csv'
            fn2 = '/Volumes/My Passport/SSP_models/new/M13_age_8_Av_00_z002.csv'
            model2 = (8.0-galaxy_age)*np.genfromtxt(fn1) + (galaxy_age-7.0)*np.genfromtxt(fn2)
        elif galaxy_age >= 8.0 and galaxy_age < 9.0:
            fn1 = '/Volumes/My Passport/SSP_models/new/M13_age_8_Av_00_z002.csv'
            fn2 = '/Volumes/My Passport/SSP_models/new/M13_age_9_Av_00_z002.csv'
            model2 = (9.0-galaxy_age)*np.genfromtxt(fn1) + (galaxy_age-8.0)*np.genfromtxt(fn2)
        elif galaxy_age >= 9.0 and galaxy_age < 10.0:
            fn1 = '/Volumes/My Passport/SSP_models/new/M13_age_9_Av_00_z002.csv'
            fn2 = '/Volumes/My Passport/SSP_models/new/M13_age_10_Av_00_z002.csv'
            model2 = (10.0-galaxy_age)*np.genfromtxt(fn1) + (galaxy_age-9.0)*np.genfromtxt(fn2)
        elif galaxy_age >= 10.0 and galaxy_age < 11.0:
            fn1 = '/Volumes/My Passport/SSP_models/new/M13_age_10_Av_00_z002.csv'
            fn2 = '/Volumes/My Passport/SSP_models/new/M13_age_11_Av_00_z002.csv'
            model2 = (11.0-galaxy_age)*np.genfromtxt(fn1) + (galaxy_age-10.0)*np.genfromtxt(fn2)
        elif galaxy_age >= 11.0 and galaxy_age < 12.0:
            fn1 = '/Volumes/My Passport/SSP_models/new/M13_age_11_Av_00_z002.csv'
            fn2 = '/Volumes/My Passport/SSP_models/new/M13_age_12_Av_00_z002.csv'
            model2 = (12.0-galaxy_age)*np.genfromtxt(fn1) + (galaxy_age-11.0)*np.genfromtxt(fn2)
        elif galaxy_age >= 12.0 and galaxy_age < 13.0:
            fn1 = '/Volumes/My Passport/SSP_models/new/M13_age_12_Av_00_z002.csv'
            fn2 = '/Volumes/My Passport/SSP_models/new/M13_age_13_Av_00_z002.csv'
            model2 = (13.0-galaxy_age)*np.genfromtxt(fn1) + (galaxy_age-12.0)*np.genfromtxt(fn2)
        elif galaxy_age >= 13.0 and galaxy_age < 14.0:
            fn1 = '/Volumes/My Passport/SSP_models/new/M13_age_13_Av_00_z002.csv'
            fn2 = '/Volumes/My Passport/SSP_models/new/M13_age_14_Av_00_z002.csv'
            model2 = (14.0-galaxy_age)*np.genfromtxt(fn1) + (galaxy_age-13.0)*np.genfromtxt(fn2)
        elif galaxy_age >= 14.0 and galaxy_age < 15.0:
            fn1 = '/Volumes/My Passport/SSP_models/new/M13_age_14_Av_00_z002.csv'
            fn2 = '/Volumes/My Passport/SSP_models/new/M13_age_15_Av_00_z002.csv'
...
filter_fn_list = []
filter_curve_list=[]
# filter_curve = np.loadtxt(filter_fn_list[i-1])
...
for i in range(13,len(df)):
    # negative photometry based on 20200303: 0, 6,7,8,9,10, 11
    row = i
...
#-------------------------------------------------Initial Reduce the spectra ----------------------------------------------------------
    ...
    print('photo flux: ',photometric_flux,len(photometry_list))
