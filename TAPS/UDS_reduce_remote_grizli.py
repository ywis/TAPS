...
tik = time.clock()
df_cat=pd.read_csv('/home/siqi/uds_3dhst_v4.1.5_catalogs/uds_3dhst.v4.1.5.zbest.rf', delim_whitespace=True,header=None,comment='#',index_col=False)
...
# df = pd.read_csv('/home/siqi/TAPS/TAPS/source_list/matching_galaxies_uds_20200303_PSB.csv', sep=',')
df = pd.read_csv('/home/siqi/TAPS/TAPS/source_list/matching_galaxies_uds_20200317_PSB.csv', sep=',')
df.columns=['detector','ID','region','filename','chip']

df_photometry=pd.read_csv('/home/siqi/uds_3dhst.v4.2.cats/Catalog/uds_3dhst.v4.2.cat', delim_whitespace=True,header=None,comment='#',index_col=False)
...
df_fast = pd.read_csv('/home/siqi/uds_3dhst.v4.2.cats/Fast/uds_3dhst.v4.2.fout', delim_whitespace=True,header=None,comment='#',index_col=False)
...
def read_spectra(row):
    ...
    if detector == 'WFC3':
        filename="/home/siqi/UDS_WFC3_V4.1.5/uds-"+"{0:02d}".format(region)+"/1D/ASCII/uds-"+"{0:02d}".format(region)+"-G141_"+"{0:05d}".format(ID)+".1D.ascii"
        OneD_1 = np.loadtxt(filename,skiprows=1)
    if detector =="ACS":
        filename="/home/siqi/UDS_ACS_V4.1.5/acs-uds-"+"{0:02d}".format(region)+"/1D/FITS/"+df.filename[row]
...
def plot_grizli_fit_M13(X,beam_g141):
    ...
    ax2.plot(beam_g141.beam.lam, beam_g141.beam.sensitivity, label='G141',linestyle='--',color='k')
    ax2.set_ylabel(r'Sensitivity[$\rm \frac{e^{-1}/s}{erg/s/cm^2}$]')
    figname=current_dir+outcome_dir+plot_dir+'Forward_Modelling_uds_M13_'\
                +str(region)+'_'+str(ID)+"_age_"+"{0:.1f}".format(galaxy_age)\
                +'_AV_'+"{0:.1f}".format(intrinsic_Av)+'.pdf'
    plt.savefig(figname)
    plt.clf()
    ...
    plt.tick_params(axis='both', which='major', labelsize=20)
    plt.tick_params(axis='both', which='minor', labelsize=20)
    figname=current_dir+outcome_dir+plot_dir+'UDS_M13_SSP_opt_'+str(region)+'_'+str(ID)+'_'+"{0:.2f}".format(X[0])+'Gyr_AV'+"{0:.2f}".format(X[1])+'_grizli.pdf'
    plt.savefig(figname)
    plt.clf()
...
def plot_grizli_fit_BC(X,beam_g141):
    ...
    ax2.plot(beam_g141.beam.lam, beam_g141.beam.sensitivity, label='G141',linestyle='--',color='k')
    ax2.set_ylabel(r'Sensitivity[$\rm \frac{e^{-1}/s}{erg/s/cm^2}$]')
    figname=current_dir+outcome_dir+plot_dir+'Forward_Modelling_UDS_BC_'\
                +str(region)+'_'+str(ID)+"_age_"+"{0:.1f}".format(galaxy_age)\
                +'_AV_'+"{0:.1f}".format(intrinsic_Av)+'.pdf'
    plt.savefig(figname)
    plt.clf()
    ...
    plt.tick_params(axis='both', which='major', labelsize=20)
    plt.tick_params(axis='both', which='minor', labelsize=20)
    figname=current_dir+outcome_dir+plot_dir+'UDS_BC_SSP_opt_'+str(region)+'_'+str(ID)+'_'+"{0:.2f}".format(X[0])+'Gyr_AV'+"{0:.2f}".format(X[1])+'_grizli.pdf'
    plt.savefig(figname)
    plt.clf()
...
path = "/home/siqi/TAPS/TAPS/filter/uds/"
import glob, os
os.chdir(path)
for i in range(1,15):
...
UDS_FLT_list=[
                '/home/siqi/uds_flt_files/ibhm01dsq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm02q3q_flt.fits',
                '/home/siqi/uds_flt_files/ibhm03raq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm04alq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm05fvq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm06jzq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm07cqq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm08ffq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm09iiq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm10keq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm11ieq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm12ubq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm13krq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm14uxq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm15znq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm16jgq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm17rrq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm18o5q_flt.fits',
                '/home/siqi/uds_flt_files/ibhm19pvq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm20l6q_flt.fits',
                '/home/siqi/uds_flt_files/ibhm21agq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm22yvq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm23gsq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm24fkq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm25mkq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm26ncq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm27qnq_flt.fits',
                '/home/siqi/uds_flt_files/ibhm28slq_flt.fits',
                ]
...
# -----Capture the FLT file -----
    sim_g141 = grizli.model.GrismFLT(grism_file='', \
                                     direct_file=UDS_FLT_list[region-1],\
...
# Using bounds to constrain M05
    ...
    #         figname=current_dir+outcome_dir+plot_dir+"UDS_triangle_M05_"+str(nsteps)+'_'+str(ID)+'_'+str(region)+'_'+"{0:.2f}".format(X[0])+'Gyr_AV'+"{0:.2f}".format(X[1])+"_grizli.pdf"
    #         fig.savefig(figname)
    #         X = np.percentile(samples, 50, axis=0)
    #         x2_optimized = minimize_age_AV_vector_weighted_grizli(X)
    #         x2_spec, x2_phot = minimize_age_AV_vector_weighted_return_chi2_sep_grizli(X)
...
# Test with the new M13 models
    ...
    #                 ax.plot(value2[xi],value2[yi],'sr')
    #         plt.rcParams.update({'font.size': 12})
    #         figname=current_dir+outcome_dir+plot_dir+"UDS_triangle_M13_"+str(nsteps)+'_'+str(region)+'_'+str(ID)+'_'+"{0:.2f}".format(X[0])+'Gyr_AV'+"{0:.2f}".format(X[1])+"_grizli.pdf"
    #         fig.savefig(figname)
    #         fig.clf()
...
## Save to catalog
    # chi_square_list.to_csv('/home/siqi/TAPS/TAPS/outcome/numeric/chi_square_list_uds_'+str(date)+'_photo_'+str(region)+'_'+str(ID)+'_grizli.csv')
    # print('-------------------------------------End--------------------------------------------------------------------------------------')

chi_square_list.to_csv('/home/siqi/TAPS/TAPS/outcome/numeric/chi_square_list_uds_'+str(date)+'_photo_'+str(region)+'_'+str(ID)+'_grizli_all.csv')
print('-------------------------------------End--------------------------------------------------------------------------------------')
