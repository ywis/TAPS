...
#------------------------------------------------- Reduce the spectra ----------------------------------------------------------
    ...
    y = y_fit*y
    print('0th coeff from polyfit before negative masking:',np.unique(y_fit))
...
# Test with the new BC03 models
    ...
    if redshift<0.49:
        try:
            ...
            pass
    chi_square_list.to_csv('/Volumes/My Passport/GV_CMD_fn_table_20180904/chi_square_list_goodsn_'+str(date)+'_photo_'+str(region)+'_'+str(ID)+'.csv')
    print('-------------------------------------End--------------------------------------------------------------------------------------')
