...
# Test with the new BC03 models
    ...
    if redshift<0.49:
        try:
            ...
            pass 
    chi_square_list.to_csv('/Volumes/My Passport/GV_CMD_fn_table_20180904/chi_square_list_cosmos-three_models_optimized_'+str(date)+'_photo'+str(ID)+'_'+str(region)+'.csv')
