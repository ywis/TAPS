...
tik = time.clock()
df_cat=pd.read_csv('/home/siqi/cosmos_3dhst_v4.1.5_catalogs/cosmos_3dhst.v4.1.5.zbest.rf',delim_whitespace=True,header=None,comment='#',index_col=False)
...
df = pd.read_csv('/home/siqi/TAPS/TAPS/source_list/matching_galaxies_cosmos_20200317_PSB.csv', sep=',')
df.columns=['detector','ID','region','filename','chip']

df_photometry=pd.read_csv('/home/siqi/cosmos_3dhst.v4.1.cats/Catalog/cosmos_3dhst.v4.1.cat', delim_whitespace=True,header=None,comment='#',index_col=False)
...
df_fast = pd.read_csv('/home/siqi/cosmos_3dhst.v4.1.cats/Fast/cosmos_3dhst.v4.1.fout', delim_whitespace=True, header=None,comment='#',index_col=False)
...
def read_spectra(row):
    ...
    if detector == 'WFC3':
        filename="/home/siqi/COSMOS_WFC3_V4.1.5/cosmos-"+"{0:02d}".format(region)+"/1D/ASCII/cosmos-"+"{0:02d}".format(region)+"-G141_"+"{0:05d}".format(ID)+".1D.ascii"
        OneD_1 = np.loadtxt(filename,skiprows=1)
    if detector =="ACS":
        filename="/home/siqi/COSMOS_ACS_V4.1.5/acs-cosmos-"+"{0:02d}".format(region)+"/1D/FITS/"+df.filename[row]
...
def plot_grizli_fit(X,beam_g141):
    ...
    figname=current_dir+outcome_dir+plot_dir+'Forward_Modelling_cosmos_M05_'\
    ...
    figname=current_dir+outcome_dir+plot_dir+'COSMOS_M05_SSP_opt_'+str(region)+'_'+str(ID)+'_'+"{0:.2f}".format(X[0])+'Gyr_AV'+"{0:.2f}".format(X[1])+'_grizli.pdf'
    plt.savefig(figname)
    plt.clf()
...
def plot_grizli_fit_M13(X,beam_g141):
    ...
    ax2.plot(beam_g141.beam.lam, beam_g141.beam.sensitivity, label='G141',linestyle='--',color='k')
    ax2.set_ylabel(r'Sensitivity[$\rm \frac{e^{-1}/s}{erg/s/cm^2}$]')
    figname=current_dir+outcome_dir+plot_dir+'Forward_Modelling_cosmos_M13_'\
                +str(region)+'_'+str(ID)+"_age_"+"{0:.1f}".format(galaxy_age)+'_AV_'+"{0:.1f}".format(intrinsic_Av)+'.png'
    plt.savefig(figname)
    plt.clf()
    # Plot in rest frame
    ...
    plt.tick_params(axis='both', which='major', labelsize=20)
    plt.tick_params(axis='both', which='minor', labelsize=20)
    figname=current_dir+outcome_dir+plot_dir+'COSMOS_M13_SSP_opt_'+str(region)+'_'+str(ID)+'_'+"{0:.2f}".format(X[0])+'Gyr_AV'+"{0:.2f}".format(X[1])+'_grizli.pdf'
    plt.savefig(figname)
    plt.clf()
...
path = "/home/siqi/TAPS/TAPS/filter/cosmos/"
import glob, os
os.chdir(path)
for i in range(1,41):
...
COSMOS_FLT_list=[
                '/home/siqi/cosmos_flt_files/ibhm29wzq_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm30zqq_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm31raq_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm32m3q_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm33mvq_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm34ymq_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm35zeq_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm36kqq_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm37omq_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm38ddq_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm39b6q_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm40byq_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm41u6q_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm42uyq_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm43w9q_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm44kvq_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm45ziq_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm46ifq_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm47h8q_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm48boq_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm49x2q_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm50suq_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm51xeq_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm52cgq_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm53onq_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm54dtq_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm55elq_flt.fits',
                '/home/siqi/cosmos_flt_files/ibhm56flq_flt.fits',
                ]

for i in [18]:
# range(len(df)):# for i in [x for x in range(len(df)-1,37,-1) if x != 61 and x !=70 and x!=75]:
    # 35: 11-27160
    # 9: 1-22611
    # 8: 1-22285
    # 7: 1-21966
...
# -----Capture the FLT file -----
    sim_g141 = grizli.model.GrismFLT(grism_file='', \
                                     direct_file=COSMOS_FLT_list[region-1],\
...
### grizli move x to observed frame for following reduction
    x = x*(1+redshift_1)
...
# Test with M05 models
    ...
    try:
        if samples.size > 1e3:
            ...
            figname=current_dir+outcome_dir+plot_dir+"cosmos_triangle_M05_"+str(nsteps)+'_'+str(ID)+'_'+str(region)+'_'+"{0:.2f}".format(X[0])+'Gyr_AV'+"{0:.2f}".format(X[1])+"_grizli.pdf"
            fig.savefig(figname)
    except:
        print('test')
    X = np.percentile(samples, 50, axis=0)
        ...
        if samples.size > 1e3 :
            ...
            for yi in range(ndim):
                for xi in range(yi):
                    ...
                    ax.plot(value2[xi],value2[yi],'sr')
            plt.rcParams.update({'font.size': 12})
            figname=current_dir+outcome_dir+plot_dir+"cosmos_triangle_M13_"+str(nsteps)+'_'+str(region)+'_'+str(ID)+'_'+"{0:.2f}".format(X[0])+'Gyr_AV'+"{0:.2f}".format(X[1])+"_grizli.pdf"
            fig.savefig(figname)
            fig.clf()
...
## Save to catalog
    chi_square_list.to_csv('/home/siqi/TAPS/TAPS/outcome/numeric/chi_square_list_cosmos_'+str(date)+'_photo_'+str(region)+'_'+str(ID)+'_grizli.csv')
