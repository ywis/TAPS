...
sys.path.append('/Users/Siqi/grizli/')
sys.path.append('/Users/Siqi/grizli/tristars/')
# get grizli
...
def plot_grizli_fit(X,beam_g141):
    ...
    plt.savefig('/Volumes/My Passport/TPAGB/outcome/plot/Forward_Modelling_goodss_'\
    ...
    figname=current_dir+outcome_dir+plot_dir+'GOODSS_M05_SSP_opt_'+str(region)+'_'+str(ID)+'_'+"{0:.2f}".format(X[0])+'Gyr_AV'+"{0:.2f}".format(X[1])+'_grizli.pdf'
    plt.savefig(figname)
...
def plot_grizli_fit_M13(X,beam_g141):
    ...
    ax2.plot(beam_g141.beam.lam, beam_g141.beam.sensitivity, label='G141',linestyle='--',color='k')
    ax2.set_ylabel(r'Sensitivity[$\rm \frac{e^{-1}/s}{erg/s/cm^2}$]')
    figname=current_dir+outcome_dir+plot_dir+'Forward_Modelling_goodss_M13'\
                +str(region)+'_'+str(ID)+"_age_"+"{0:.1f}".format(galaxy_age)+'_AV_'+"{0:.1f}".format(intrinsic_Av)+'.png'
    plt.savefig(figname)
...
GOODSS_FLT_list=[
                '/Volumes/My Passport/goodss_flt_files/ibhj01j2q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj02l5q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj03y0q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj04fmq_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj05n1q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj06p7q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj07yeq_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj08z6q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj09h2q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj10vdq_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj11i1q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj12i8q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj13w5q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj14z9q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj15x6q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj16b1q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj17p4q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj18o2q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj19p1q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj20x5q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj21c0q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj22f4q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj23t2q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj24r7q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj25b6q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj26f6q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj27b7q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj28h0q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj29naq_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj30c4q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj31h1q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj32r0q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj33u1q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj34h6q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj35w6q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj36i2q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj37u8q_flt.fits',
                '/Volumes/My Passport/goodss_flt_files/ibhj38a4q_flt.fits'
                ]
...
# -----Capture the FLT file -----
    sim_g141 = grizli.model.GrismFLT(grism_file='', \
                                     direct_file=GOODSS_FLT_list[region-1],\
                                     #'/Volumes/My Passport/goodss_flt_files/ibhj33u1q_flt.fits',
...
#-------------------------------------------------Initial Reduce the spectra ----------------------------------------------------------
    ...
    print('photo flux SNR:', wave_list,photometric_flux/photometric_flux_err)
    ...
    # plt.savefig('/Volumes/My Passport/TPAGB/outcome/plot/sensitivity_goodss_20200408.pdf')
    plt.clf()
    x = x*(1+redshift_1)
        ...
        if samples.size > 1e3 :
            ...
            for yi in range(ndim):
                for xi in range(yi):
                    ...
                    ax.plot(value2[xi],value2[yi],'sr')
            plt.rcParams.update({'font.size': 12})
            figname=current_dir+outcome_dir+plot_dir+"goodss_triangle_M13_"+str(nsteps)+'_'+str(region)+'_'+str(ID)+'_'+"{0:.2f}".format(X[0])+'Gyr_AV'+"{0:.2f}".format(X[1])+"_grizli.pdf"
            fig.savefig(figname)
            fig.clf()
...
#         except:
#             pass
#     chi_square_list.to_csv('/Volumes/My Passport/GV_CMD_fn_table_20180904/chi_square_list_goodss_'+str(date)+'_photo_'+str(region)+'_'+str(ID)+'.csv')
#     print('-------------------------------------End--------------------------------------------------------------------------------------')
