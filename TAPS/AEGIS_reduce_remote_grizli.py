...
def plot_grizli_fit(X,beam_g141):
    ...
    figname=current_dir+outcome_dir+plot_dir+'Forward_Modelling_AEGIS_M05_'\
    ...
    figname=current_dir+outcome_dir+plot_dir+'AEGIS_M05_SSP_opt_'+str(region)+'_'+str(ID)+'_'+"{0:.2f}".format(X[0])+'Gyr_AV'+"{0:.2f}".format(X[1])+'_grizli.pdf'
    plt.savefig(figname)
    plt.clf()
...
def plot_grizli_fit_M13(X,beam_g141):
    ...
    ax2.plot(beam_g141.beam.lam, beam_g141.beam.sensitivity, label='G141',linestyle='--',color='k')
    ax2.set_ylabel(r'Sensitivity[$\rm \frac{e^{-1}/s}{erg/s/cm^2}$]')
    figname=current_dir+outcome_dir+plot_dir+'Forward_Modelling_aegis_M13_'\
                +str(region)+'_'+str(ID)+"_age_"+"{0:.1f}".format(galaxy_age)\
                +'_AV_'+"{0:.1f}".format(intrinsic_Av)+'.pdf'
    plt.savefig(figname)
    plt.clf()
    ...
    plt.tick_params(axis='both', which='major', labelsize=20)
    plt.tick_params(axis='both', which='minor', labelsize=20)
    figname=current_dir+outcome_dir+plot_dir+'AEGIS_M13_SSP_opt_'+str(region)+'_'+str(ID)+'_'+"{0:.2f}".format(X[0])+'Gyr_AV'+"{0:.2f}".format(X[1])+'_grizli.pdf'
    plt.savefig(figname)
    plt.clf()
...
def plot_grizli_fit_BC(X,beam_g141):
    ...
    ax2.plot(beam_g141.beam.lam, beam_g141.beam.sensitivity, label='G141',linestyle='--',color='k')
    ax2.set_ylabel(r'Sensitivity[$\rm \frac{e^{-1}/s}{erg/s/cm^2}$]')
    figname=current_dir+outcome_dir+plot_dir+'Forward_Modelling_AEGIS_BC_'\
                +str(region)+'_'+str(ID)+"_age_"+"{0:.1f}".format(galaxy_age)\
                +'_AV_'+"{0:.1f}".format(intrinsic_Av)+'.pdf'
    plt.savefig(figname)
    plt.clf()
    ...
    plt.tick_params(axis='both', which='major', labelsize=20)
    plt.tick_params(axis='both', which='minor', labelsize=20)
    figname=current_dir+outcome_dir+plot_dir+'AEGIS_BC_SSP_opt_'+str(region)+'_'+str(ID)+'_'+"{0:.2f}".format(X[0])+'Gyr_AV'+"{0:.2f}".format(X[1])+'_grizli.pdf'
    plt.savefig(figname)
    plt.clf()
...
AEGIS_FLT_list=[
                '/home/siqi/aegis_flt_files/ibhj39v6q_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj40hoq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj41gsq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj42ohq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj43p9q_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj44nnq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj45niq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj46bdq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj47ckq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj48o4q_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj49awq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj50euq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj51tcq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj52brq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj53jbq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj54s1q_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj55uaq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj56s2q_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj57y8q_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj58ehq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj59ctq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj59ctq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj61quq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj62m9q_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj63dtq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj64dlq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj65goq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj66ddq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj67moq_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj68i0q_flt.fits',
                '/home/siqi/aegis_flt_files/ibhj69hlq_flt.fits',
                ]
...
# -----Capture the FLT file -----
    sim_g141 = grizli.model.GrismFLT(grism_file='', \
                                     direct_file=AEGIS_FLT_list[region-1],\
...
# Test with M05 models
    ...
    #         figname=current_dir+outcome_dir+plot_dir+"aegis_triangle_M05_"+str(nsteps)+'_'+str(ID)+'_'+str(region)+'_'+"{0:.2f}".format(X[0])+'Gyr_AV'+"{0:.2f}".format(X[1])+"_grizli.pdf"
    #         fig.savefig(figname)
    #         X = np.percentile(samples, 50, axis=0)
    #         x2_optimized = minimize_age_AV_vector_weighted_grizli(X)
    #         x2_spec, x2_phot = minimize_age_AV_vector_weighted_return_chi2_sep_grizli(X)
...
# Test with the new M13 models
    ...
    #                 ax.plot(value2[xi],value2[yi],'sr')
    #         plt.rcParams.update({'font.size': 12})
    #         figname=current_dir+outcome_dir+plot_dir+"AEGIS_triangle_M13_"+str(nsteps)+'_'+str(region)+'_'+str(ID)+'_'+"{0:.2f}".format(X[0])+'Gyr_AV'+"{0:.2f}".format(X[1])+"_grizli.pdf"
    #         fig.savefig(figname)
    #         fig.clf()
...
# Test with the new BC03 models
    ...
    #                 ax.plot(value2[xi],value2[yi],'sr')
    #         plt.rcParams.update({'font.size': 12})
    #         figname=current_dir+outcome_dir+plot_dir+"AEGIS_triangle_BC03_"+str(nsteps)+'_'+str(region)+'_'+str(ID)+'_'+"{0:.2f}".format(X[0])+'Gyr_AV'+"{0:.2f}".format(X[1])+"_grizli.pdf"
    #         plt.savefig(figname)
    #         plt.clf()
    ...
    #     pass
## Save to catalog
chi_square_list.to_csv('/home/siqi/TAPS/TAPS/outcome/numeric/chi_square_list_aegis_'+str(date)+'_photo_'+str(region)+'_'+str(ID)+'_grizli_all.csv')
print('-------------------------------------End--------------------------------------------------------------------------------------')
